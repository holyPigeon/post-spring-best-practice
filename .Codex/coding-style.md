# Coding Style - Codex Instruction Set
...
- NEVER setter. State changes via domain methods only (for example, `confirm()`, `cancel()`)
...
- Domain-specific exception per entity (for example, `PostNotFoundException`)
